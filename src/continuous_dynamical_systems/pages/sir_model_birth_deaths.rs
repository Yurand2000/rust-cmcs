...
#[wasm_bindgen(js_name = CDS_SLE_SIR_BD)]
pub struct Model { }

#[wasm_bindgen(js_name = CDS_SLE_SIR_BD_Params)]
pub struct Params {
    solver: ODESolver,
    max_time: f32,
...
#[wasm_bindgen(js_class = CDS_SLE_SIR_BD)]
impl Model {
...
#[wasm_bindgen(js_class = CDS_SLE_SIR_BD_Params)]
impl Params {
    pub fn builder() -> Self {
        Self { solver: ODESolver::RK4, max_time: 1f32, max_population_display: 0f32, initial_susceptible_pop: 0f32, initial_infected_pop: 0f32, initial_recovered_pop: 0f32,
            infection_coefficient: 0f32, recovery_coefficient: 0f32, birth_rate: 0f32 }
    }
